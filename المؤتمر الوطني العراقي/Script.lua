...
if not msg.SudoBase then return "*-›* هذا الامر يخص {بابا} فقط يغالي  " end
local GetVerison = https.request('https://github.com/KDJEONDHOSN/max.github.io/GetVersion.txt') or 0
...
-› [اضغط هنا عندنا لك مفاجأة](https://t.me/WTTTW)
]] )
--=====================================
